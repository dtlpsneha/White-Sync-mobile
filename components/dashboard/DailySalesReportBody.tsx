...
/**
 * The Daily Sales Report screen's full body (filters, chip row, table,
 * filters/picker sheets) minus its own back-button topbar — extracted so
 * both the standalone route (`app/daily-sales-report.tsx`) and the Home
 * screen can render the exact same logic without duplicating it.
 */
export function DailySalesReportBody() {
